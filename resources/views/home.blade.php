...
@section('content')
    <div class="container">
        ...
        <a href="{{route('customer-orders.create')}}" class="btn btn-success btn-block shadow my-2"><i
        ...
        <div dir="rtl" class="row">
            ...
            @if(count($orders->where('status_id',2)))
                <div class="col-md-3 mb-2">
                    ...
                    <a class="text-dark"
                       href="{{route('customer-orders.show',$orders->where('status_id',2)->first()->id)}}"
                       style="text-decoration: none;">
                        <div class="card bg-warning border-warning shadow">
                            ...
                            <div class="card-body">
                                ...
                                <span class="persian-num font-weight-bolder mx-3 float-left" style="font-size: 3rem;">
