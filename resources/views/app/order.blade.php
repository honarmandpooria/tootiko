    ...
    <div class="container">
        ...
        <div class="bg-white shadow rounded p-4">
            ...
            <form method="POST" action="/">
                ...
                <h4 class=" text-right mb-4 text-muted"><span
                        class="font-weight-bold text-success">۱)</span>
                ...
                <h4 class=" text-right mb-4 text-muted"><span
                        class="font-weight-bold text-success">۲)</span>
                ...
                <h4 class=" text-right mb-4 text-muted"><span
                        class="font-weight-bold text-success">۳)</span>
                ...
                <div class="text-center">
                    <div class="custom-control form-control-lg custom-radio custom-control-inline">
                        ...
                        <input type="radio" name="quality_id" value="1" id="radio1" class="custom-control-input">
                    ...
                    <div class="custom-control form-control-lg custom-radio custom-control-inline">
                        ...
                        <input type="radio" name="quality_id" value="2" id="radio2" class="custom-control-input">
                    ...
                    <div class="custom-control form-control-lg custom-radio custom-control-inline">
                        ...
                        <input type="radio" name="quality_id" value="3" id="radio3" class="custom-control-input">
                ...
                <h4 class=" text-right mb-4 text-muted"><span
                        class="font-weight-bold text-success">۴)</span>
                    انتخاب حق دسترسی</h4>
                ...
                <h4 class=" text-right mb-4 text-muted"><span
                        class="font-weight-bold text-success">۵)</span>
                    مهلت ترجمه</h4>
                <div class="clearfix">
                ...
                <h4 class=" text-right mb-4 text-muted"><span
                        class="font-weight-bold text-success">۶)</span>
                    توضیحات</h4>
                ...
                <div class="form-group">
                    {{--            {!! Form::submit('ثبت سفارش',['class'=>'btn btn-success float-right mt-4']) !!}--}}
                    <button type="submit" class="btn btn-success mt-4">ثبت سفارش</button>
                </div>
